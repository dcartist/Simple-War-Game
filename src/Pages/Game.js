...
export default class Game extends Component {
    ...
    render() {
        ...
        return(
            ...
            return(
                <div className="default-background black-background">
                  ...
                  <div className="card-placement"> WAR!
                    <button onClick={this.activateWar}>Enter the War</button></div>
                  <div className="card-placement">
        ...
        return (
            <div className="default-background red-background centered">
            ...
            return (
                <div className="default-background red-background">
                    ...
                    <p>Winner of round: {this.props.winnerOfRound}</p>
